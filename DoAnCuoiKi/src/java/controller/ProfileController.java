 ...
 Tour tour = new Tour();
        ...
        if (action.equals("viewprofile")) {
            ...
            if (user != null) {
                ...
                userinfor = UserDB.selectUserInfor(userid);
                            session.setAttribute("UserInfor", userinfor);
                            session.setAttribute("user", user);
            url = "/userinfor.jsp";
            }
        }
        if (action.equals("Back to home")) {
        ...
        if (action.equals("edit")) {
            ...
            userinfor = UserDB.selectUserInfor(userid);
                ...
                userinfor.setLastName(lastname);
                userinfor.setLocate(locate);
                userinfor.setNphone(numberphone);
                UserDB.updateUserInfor(userinfor);
                userinfor = UserDB.selectUserInfor(userid);
            session.setAttribute("UserInfor", userinfor);
            url = "/userinfor.jsp";
        }
