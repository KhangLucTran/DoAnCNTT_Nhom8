...
<html>
    ...
    <body>
        <div class="main">
            ...
            <div class="row">
                <div class="col-sm-9">
                    <h2> <b> Edit Tour <i class="material-icons" data-toggle="tooltip" title="Update">&#xE254;</i></b></h2> 
                </div>
                <div class="col-sm-6">
                ...
                <form action="ManagerController" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>ID</label>
                            <input value="${tour.idTour}" name="tourid" type="text" class="form-control" readonly required>
                        </div>
                        <div class="form-group">
                            <label>Name Tour</label>
                            <input id="name" name="name" type="text" class="form-control" value="${tour.tourName}" onkeyup="checkForm()" required>
                        </div>
                        <div class="form-group">
                            <label>Image 1 </label>
                            <input id="image1" name="image1" type="text" class="form-control" value="${tour.getImageLink(0)}" onkeyup="checkForm()" required>
                        </div>
                        <div class="form-group">
                            <label>Title image 1</label>
                            <textarea id="title1" name="title1" class="form-control" onkeyup="checkForm()" required>${tour.getImageTitle(0)}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Image 2</label>
                            <input id="image2" name="image2" type="text" class="form-control" value="${tour.getImageLink(1)}" onkeyup="checkForm()" required>
                        </div>
                        <div class="form-group">
                            <label>Title image 2</label>
                            <textarea id="title2" name="title2" class="form-control"  onkeyup="checkForm()" required>${tour.getImageTitle(1)}</textarea>
                        </div>


                        <div class="form-group">
                            <label>Image 3</label>
                            <input id="image3" name="image3" type="text" class="form-control" value="${tour.getImageLink(2)}" onkeyup="checkForm()" required>
                        </div>
                        <div class="form-group">
                            <label>Title image 3</label>
                            <textarea id="title3" name="title3" class="form-control" onkeyup="checkForm()" required>${tour.getImageTitle(2)}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Image 4</label>
                            <input id="image4" name="image4" type="text" class="form-control" value="${tour.getImageLink(3)}" onkeyup="checkForm()" required>
                        </div>
                        <div class="form-group">
                            <label>Title image 4</label>
                            <textarea id="title4" name="title4" class="form-control" onkeyup="checkForm()" required>${tour.getImageTitle(3)}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Image 5</label>
                            <input id="image5" name="image5" type="text" class="form-control" value="${tour.getImageLink(4)}" onkeyup="checkForm()" required>
                        </div>
                        <div class="form-group">
                            <label>Title image 5</label>
                            <textarea id="title5" name="title5" class="form-control" onkeyup="checkForm()" required>${tour.getImageTitle(4)}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Image 6</label>
                            <input id="image6" name="image6" type="text" class="form-control" value="${tour.getImageLink(5)}" onkeyup="checkForm()" required>
                        </div>
                        <div class="form-group">
                            <label>Title image 6 </label>
                            <textarea id="title6" name="title6" class="form-control" onkeyup="checkForm()" required>${tour.getImageTitle(5)}</textarea>
                        </div>

                        <div class="form-group">
                            <label>Description 1</label>
                            <textarea id="description1" name="description1" class="form-control" onkeyup="checkForm()" required>${tour.getDescription(0)}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Description 2</label>
                            <textarea id="description2" name="description2" class="form-control" onkeyup="checkForm()" required>${tour.getDescription(1)}</textarea>
                        </div><div class="form-group">
                            <label>Description 3</label>
                            <textarea id="description3" name="description3" class="form-control" onkeyup="checkForm()" required>${tour.getDescription(2)}</textarea>
                        </div><div class="form-group">
                            <label>Description 4</label>
                            <textarea id="description4" name="description4" class="form-control" onkeyup="checkForm()" required>${tour.getDescription(3)}</textarea>
                        </div><div class="form-group">
                            <div class="form-group">
                                <label>date_start</label>
                                <input id="dateStart" name="date_start" type="date" class="form-control" value="${tour.formatDate(tour.dateStart)}" onkeyup="checkForm()" required>
                            </div>
                            <div class="form-group">
                                <label>date_end</label>
                                <input id="dateEnd" name="date_end" type="date"  class="form-control" value="${tour.formatDate(tour.dateEnd)}"  onkeyup="checkForm()" required>
                            </div>
                            <label>The trip's schedule </label>
                            <textarea id="schedule" name="schedule"  class="form-control" onkeyup="checkForm()" required>${tour.getDescription(4)}</textarea>
                        </div>

                        <div class="form-group">
                            <label>transportation</label>
                            <input id="transportation" name="transportation" type="text" value="${tour.transportation}" class="form-control" onkeyup="checkForm()"required>
                        </div>

                        <div class="form-group">
                            <label>accommodation</label>
                            <input id="accommodation" name="accommodation" type="text" class="form-control" value="${tour.accommodations}" onkeyup="checkForm()" required>
                        </div>
                        <div class="form-group">
                            <label>ggMap</label>
                            <textarea id="ggMap" name="ggMap" type="text" class="form-control" onkeyup="checkForm()" required>${tour.linkGGmap}</textarea>
                        </div>

                        <div class="form-group">
                            <label>Price</label>
                            <input id="price" name="price" type="text" class="form-control" value="${tour.price}" onkeyup="checkForm()" required>
                        </div>
